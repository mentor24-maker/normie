...
export default async function PlayerPointsPage() {
    ...
    <section className="player-dashboard-grid">
      <article className="panel player-token-panel">
        ...
        <p className="panel-copy">
          ...
          ledger for future rewards, streaks, and wallet features.
        </p>
        <Link className="submit-button player-primary-link" href="/">
          Answer More Polls
        </Link>
      </article>
        ...
        <div className="player-answer-list">
          <div className="player-answer-row">
            <div>
              ...
              <span>
                {snapshot.pollsTaken} registered answer{snapshot.pollsTaken === 1 ? "" : "s"}
              </span>
            </div>
            <div className="player-answer-choice">
              {snapshot.tokensEarned} point{snapshot.tokensEarned === 1 ? "" : "s"}
            </div>
          </div>
        </div>
      </article>
