...
import { readPlayerTesterPollSettings } from "./player-tester-poll";
...
export function mergePublicUserRecord(
  ...
  const testerSettings = readPlayerTesterPollSettings(profile);
  ...
  return {
    ...
    isTester: testerSettings.isTester,
    testerPollId: testerSettings.testerPollId,
