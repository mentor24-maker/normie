...
export const POLL_ADMIN_SELECT = `id, category_id, ${POLL_CATEGORY_JOIN}, collection, question, deep_dive, deep_dive_youtube_url, deep_dive_blog_post_id, deep_dive_related_poll_ids, image_url, order_index, created_at, is_published, is_hidden, poll_options(id, label, sort_order)`;
