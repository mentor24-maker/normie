...
function NavModuleEditor({
  ...
  function persist(nextItems: NavItem[]) {
    onUpdateModule((current) => ({
      ...
      settings: {
        ...current.settings,
        navItems: serializeNavItems(nextItems)
      }
    }));
  }
  ...
  function addItem() {
    persist([
      ...items,
      {
        id: `nav-${Date.now()}-${items.length + 1}`,
        label: "",
        href: ""
      }
    ]);
      ...
      <div className="builder-slider-design-grid">
        <label className="field">
          ...
          <input
            ...
            onChange={(e) => updateSetting("navFontSize", e.target.value)}
          />
        </label>
        <label className="field builder-checkbox-field">
          <span>Bold</span>
        ...
        <label className="field">
          ...
          <input
            ...
            onChange={(e) => updateSetting("navBorderRadius", e.target.value)}
          />
        </label>
        <label className="field">
          <span>Padding</span>
          <input
            type="text"
            value={module.settings.navPadding ?? "8px 12px"}
            onChange={(e) => updateSetting("navPadding", e.target.value)}
        ...
        <label className="field">
          ...
          <input
            type="text"
            value={module.settings.navBackground ?? ""}
            onChange={(e) => updateSetting("navBackground", e.target.value)}
        ...
        <label className="field">
          ...
          <input
            ...
            onChange={(e) => updateSetting("navColor", e.target.value)}
            placeholder="#ffffff"
          />
        </label>
        <label className="field">
          ...
          <input
            ...
            onChange={(e) => updateSetting("navHoverColor", e.target.value)}
            placeholder="#ffffff"
          />
        </label>
        <label className="field">
          ...
          <input
            ...
            onChange={(e) => updateSetting("navHoverBackground", e.target.value)}
          ...
          <div key={item.id} className="builder-slider-item-card">
            <div className="builder-slider-item-header">
              ...
              <div className="builder-section-actions">
                ...
                <button type="button" className="builder-icon-button builder-icon-button-danger" onClick={() => removeItem(item.id)} title="Delete link">
                  ✕
                </button>
              </div>
            </div>
